...
This is a patch of the CAMB Boltzmann code implementing the Omnipotent dark energy model (`2306.08046 <https://arxiv.org/abs/2306.08046>`_), specifically of Eqs.(2,3) of the paper.
The model parameters are α, β and $a_m$; they extend the stardard phenomenology (at the background level only) of the cosmological constant.
